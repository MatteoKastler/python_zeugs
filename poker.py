...
combination_str = ["Highcard", "Pair", "two Pairs", "Triple", "Straight", "Flush","Full house", "Poker", "Straight Flush", "Royal Flush"]
...
for i in range(10000000):
    ...
    if(max(checkStraights(cards), checkHighestPair(cards))>3):
